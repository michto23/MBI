...
var MatrixNode = /** @class */ (function () {
     ...
     */
    MatrixNode.prototype.getValue = function () {
        return this.value_;
    };
    /**
     ...
     */
    MatrixNode.prototype.setValue = function (value) {
        this.value_ = value;
    };
    /**
     ...
     */
    MatrixNode.prototype.addPreviousCell = function (cell) {
     ...
     */
    MatrixNode.prototype.getPreviousCells = function () {
 ...
 */
var SequenceAligner = /** @class */ (function () {
    /**
     * The constructor
     * @constructor
     ...
     */
    function SequenceAligner(seqA, seqB, seqC) {
        // Store the sequences
        this.seqA_ = seqA;
        this.seqB_ = seqB;
        this.seqC_ = seqC;
     ...
     */
    SequenceAligner.prototype.initFMatrix = function (dimA, dimB, dimC) {
        this.fMatrix_ = new Array();
        for (var a = 0; a < dimA; ++a) {
            var chunk2 = new Array();
            for (var b = 0; b < dimB; ++b) {
                var chunk1 = new Array();
                for (var c = 0; c < dimC; ++c)
     ...
     */
    SequenceAligner.prototype.getMatrixValue = function (a, b, c) {
     ...
     */
    SequenceAligner.prototype.setMatrixValue = function (a, b, c, value) {
     ...
     */
    SequenceAligner.prototype.setPenaltyPair = function (nucl1, nucl2, value) {
     ...
     */
    SequenceAligner.prototype.getPenaltyPair = function (nucl1, nucl2) {
     ...
     * @returns {number} The value of the penalty.
     */
    SequenceAligner.prototype.getPenaltyTrio = function (nucl1, nucl2, nucl3) {
     ...
     */
    SequenceAligner.prototype.moveToNextCell = function () {
     ...
     * @param cell
     */
    SequenceAligner.prototype.addMatrixPreviousCell = function (a, b, c, cell) {
     ...
     */
    SequenceAligner.prototype.getMatrixPreviousCells = function (a, b, c) {
     ...
     */
    SequenceAligner.prototype.calcReachableValue = function (a, b, c, p1, p2, p3) {
        var v = this.getMatrixValue(a, b, c);
        var p = this.getPenaltyTrio(p1, p2, p3);
        var ps = p.toString();
        if (ps[0] === "-")
            ps = "(" + ps + ")";
        var n = v + p;
     ...
     */
    SequenceAligner.prototype.calcCurrentCell = function () {
        var a = this.currentIdx[0];
        var b = this.currentIdx[1];
        var c = this.currentIdx[2];
        this.lastStepInfo_ = "";
     ...
     */
    SequenceAligner.prototype.getSolutions = function () {
        var startCell = [this.seqA_.length, this.seqB_.length, this.seqC_.length];
     ...
     * @returns {any}
     */
    SequenceAligner.prototype.traverseSolutions = function (cell, seqs, cells) {
        var reachableCells = this.getMatrixPreviousCells(cell[0], cell[1], cell[2]);
        if (reachableCells.length == 0) {
            // This is the final cell
            return [seqs, cells];
        }
        var results = new Array();
        for (var c = 0; c < reachableCells.length; ++c) {
            var sA = ((reachableCells[c][0] - cell[0]) == 0) ? "-" : this.seqA_[reachableCells[c][0]];
            var sB = ((reachableCells[c][1] - cell[1]) == 0) ? "-" : this.seqB_[reachableCells[c][1]];
            var sC = ((reachableCells[c][2] - cell[2]) == 0) ? "-" : this.seqC_[reachableCells[c][2]];
            var seqsResult = [sA + seqs[0], sB + seqs[1], sC + seqs[2]];
            var cellsResult = [reachableCells[c]].concat(cells);
            var partialResults = this.traverseSolutions(reachableCells[c], seqsResult, cellsResult);
     ...
     */
    SequenceAligner.prototype.doOneStep = function () {
     ...
     */
    SequenceAligner.prototype.doAllSteps = function () {
        try {
            while (true) {
                this.doOneStep();
            }
     ...
     */
    SequenceAligner.prototype.getLastStepInfo = function () {
